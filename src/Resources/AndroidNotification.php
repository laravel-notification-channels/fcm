...
class AndroidNotification implements FcmResource
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'notification_priority' => ! is_null($this->getNotificationPriority()) ? $this->getNotificationPriority()->label : null,
            ...
            'visibility' => ! is_null($this->getVisibility()) ? $this->getVisibility()->label : null,
